...
const LoginWithGoogleButton = () => {
  ...
  return (
    <div onClick={()=>{(handleLoginWithGoogle())}} className='flex w-full items-center justify-between gap-2 py-2 px-4 bg-[#f9f9f9] hover:bg-gray-100 border rounded cursor-pointer'>
