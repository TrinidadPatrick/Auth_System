...
const LoginWithGoogleButton = () => {
  ...
  return (
    <div onClick={()=>{(handleLoginWithGoogle())}} className='flex w-full items-center justify-between gap-2 py-1.5 px-4 bg-[#f9f9f9] hover:bg-gray-100 border rounded cursor-pointer'>
        ...
        <p className='text-black text-sm w-full  text-center '>Continue with Google</p>
    </div>
  )
}
